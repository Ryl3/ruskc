...
(1, 'russ', 'eel', 867353423, 'Male', 'Single', 'cebu');
...
INSERT INTO `tbl_hotel` (`h_id`, `cl_id`, `us_id`, `h_status`, `h_desc`, `h_rent`) VALUES
(2, 1, 1, 'booked', '4 table family dinner', 25000);
...
(1, 'kc', 'karl', 'kc@kc.com', 'kc', 'kc'),
(2, 'karl', 'karl', 'karl@karl.com', 'karl', 'karl');
...
--
ALTER TABLE `tbl_client`
  MODIFY `cl_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_user`
  MODIFY `us_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
