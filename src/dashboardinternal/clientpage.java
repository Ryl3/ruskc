...
public class clientpage extends javax.swing.JInternalFrame {
    ...
    public void displaydata(){
             try{
                 ...
                 ResultSet rs = dbc.getdata("SELECT * FROM tbl_client");
    ...
    private void initComponents() {
        ...
        clientstable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
       ...
       if(rowindex<0){
           JOptionPane.showMessageDialog(null, "Please Select an Item!");
            ...
            clientInfo uri = new clientInfo();
                uri.clientid.setText(""+model.getValueAt(rowindex, 0));
                uri.fname.setText(""+model.getValueAt(rowindex, 1));
                uri.lname.setText(""+model.getValueAt(rowindex, 2));
                uri.mobile.setText(""+model.getValueAt(rowindex, 3));
                uri.gender.setSelectedItem(""+model.getValueAt(rowindex, 4).toString());
                uri.status.setSelectedItem(""+model.getValueAt(rowindex, 5).toString());
                uri.address.setText(""+model.getValueAt(rowindex, 6));
                uri.setVisible(true);
                uri.action = "Edit";
        ...
        if(rowindex < 0){
            ...
            int a = JOptionPane.showConfirmDialog(null, "Are you sure to Delete ID: " +id);
                if(a == JOptionPane.YES_OPTION){
                    ...
                    dbc.deletedata(c_id, "tbl_client", "cl_id");
                    displaydata();
                }
        }
