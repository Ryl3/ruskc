...
public class hotelpage extends javax.swing.JInternalFrame {
    ...
    public void displaydata() {
        try {
            ...
            ResultSet rs = dbc.getdata("SELECT `h_id`,`tbl_client`.`cl_id`,`tbl_user`.`us_id`,`tbl_user`.`us_fname`,`tbl_user`.`us_lname`, "
                    + "`tbl_user`.`us_email`,`tbl_client`.`cl_mobile`,`tbl_client`.`cl_address`,`h_status`,`h_desc`,`h_rent` FROM tbl_hotel "
                    + "LEFT JOIN tbl_user ON tbl_hotel.us_id = tbl_user.us_id LEFT JOIN tbl_client ON tbl_hotel.cl_id = tbl_client.cl_id");
    ...
    private void initComponents() {
        ...
        hoteltable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        if (rowindex < 0) {
            ...
            uri.fname.setText("" + model.getValueAt(rowindex, 3));
            uri.lname.setText("" + model.getValueAt(rowindex, 4));
            uri.email.setText("" + model.getValueAt(rowindex, 5));
            uri.mobile.setText("" + model.getValueAt(rowindex, 6));
            uri.address.setText("" + model.getValueAt(rowindex, 7));
            uri.status.setSelectedItem("" + model.getValueAt(rowindex, 8));
            uri.desc.setText("" + model.getValueAt(rowindex, 9));
            uri.rent.setText("" + model.getValueAt(rowindex, 10));
            uri.setVisible(true);
            uri.action = "Edit";
